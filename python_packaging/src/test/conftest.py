...
def gmxcli():
    # TODO: Find a more canonical way to identify the GROMACS commandline wrapper binary.
...
def spc216(gmxcli):
    ...
    # TODO: Fetch MD input from package / library data.
    # Example:
    ...
    # TODO: Don't rely on so many automagical behaviors (as described in comments below)
