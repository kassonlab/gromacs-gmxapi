        ...
        def build(self, dag):
            ...
            def launch(rank=None):
                ...
                if 'end_time' in self.runtime_params:
                    ...
                    _gmxapi.copy_tprfile(source=infile[rank],
...
class _libgromacsContext(object):
    ...
    def check_workspec(cls, workspec, raises=False):
        ...
        """
        from gmxapi.workflow import workspec_version, get_source_elements
...
class Context(object):
    ...
    def __init__(self, work=None, workdir_list=None, communicator=None):
        ...
        from gmxapi.workflow import WorkSpec
    ...
    def work(self, work):
        ...
        """
        from gmxapi.workflow import WorkSpec, WorkElement
        if work is None:
            return
