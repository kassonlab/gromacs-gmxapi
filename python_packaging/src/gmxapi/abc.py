...
#
# Example: Context, Session, run
# 1.
# 2.
# 3.
#
# Example: Start building node, build node (returning handle), user executes handle
# 1.
# 2.
# 3.
#
# Example: Get runner for a node, provide resources to the runner, execute the runner to bring the node output up to
# date.
# 1.
# 2.
# 3.
#
# Example: Contact the dispatch servicer, provide local resource handles, request service.
# 1.
# 2.
# 3.
#
